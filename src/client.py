...
class App(Tk):
    ...
    def draw_ui(self):
        ...
        self.port_input = Entry(
            self.server_connection_div, textvariable=self.port_input_str, width=10
        )
    ...
    def position_ui(self):
        ...
        self.port_input.grid(row=0, column=2, padx=5)
...
class GameClient(threading.Thread):
    ...
    def run(self):
        try:
            ...
            self.port = self.app.port_input_str.get()
            ...
            self.app.port_input.config(state=DISABLED)
